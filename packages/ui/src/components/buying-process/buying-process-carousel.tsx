  ...
  return (
    ...
    >
      <mask
        ...
        fill="black"
      >
        <rect fill="white" x="-0.699951" y="-0.700195" width="38" height="38" />
...
function SearchIcon({ className }: { className?: string }) {
  return (
    <img src="/images/buying-process/SearchIcon.png" alt="Search" className={className} />
  );
}
 
function ShieldCheckIcon({ className }: { className?: string }) {
  return (
    <img src="/images/buying-process/ShieldCheck.png" alt="Shield Check" className={className} />
  );
}
 
function ClipboardIcon({ className }: { className?: string }) {
  return (
    <img src="/images/buying-process/ClipBoard.png" alt="Clipboard" className={className} />
  );
}
