...
export function BuyingProcess() {
  return (
    <section className="relative h-[680px] w-full overflow-hidden lg:h-[820px]">
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col items-center justify-end px-4 pb-6 sm:px-6 lg:pb-16 lg:px-8">
        {/* Title */}
        <h2 className="mb-8 text-center text-2xl font-semibold text-white lg:mb-12 lg:text-3xl">
